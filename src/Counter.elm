...
view model =
    div [ class "counter grid gap-1 text-center" ]
        ...
        , a [ href "https://github.com/bmehder/elm-counter/blob/main/src/Counter.elm", target "_blank", style "display" "block" ] [ text "/src/Counter.elm" ]
        , a [ href "https://svelte.dev/playground/9a487f214b514968a556997f456e8b00?version=5.16.1", target "_blank", style "display" "block" ] [ text "$lib/Counter.svelte" ]
        ]

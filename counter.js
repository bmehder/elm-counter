...
var $author$project$Counter$Decrement = function (a) {
	return {$: 1, a: a};
};
var $author$project$Counter$Increment = function (a) {
	return {$: 0, a: a};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('bg-blue-9'),
						$elm$html$Html$Events$onClick(
						$author$project$Counter$Increment(10))
					]),
				_List_fromArray(
					[
					...
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('bg-blue-9'),
								$elm$html$Html$Events$onClick(
								$author$project$Counter$Decrement(1))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('bg-transparent pointer'),
								$elm$html$Html$Events$onClick($author$project$Counter$Reset)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('bg-blue-9'),
								$elm$html$Html$Events$onClick(
								$author$project$Counter$Increment(1))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('+1')
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('bg-blue-9'),
						$elm$html$Html$Events$onClick(
						$author$project$Counter$Decrement(10))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('-10')
...
var $author$project$Counter$main = $elm$browser$Browser$sandbox(
	{at: $author$project$Counter$init, aB: $author$project$Counter$update, aC: $author$project$Counter$view});
